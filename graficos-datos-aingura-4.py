...
CSV_PATH = r"C:\Users\chdem\0UNIVERSIDAD\Aingura\data2\MT002_ENSAYO_3_NEW_FEATURES.csv"
...
CHANGEPOINTS = [41300, 47800, 55000, 59150, 67600, 76500, 87400, 89550, 90945, 93830, 97095, 98160, 100485, 102240, 103711]              # row positions where red vertical lines should appear

def plot_multiseries(df, cols, title, changepoints=None):
    if df.empty:
        return
...
for i, part in enumerate(dfs, 1):
    plot_multiseries(part, cols, f"Segment {i} (gap split > {GAP})", CHANGEPOINTS)
